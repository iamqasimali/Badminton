  ...
  return (
    <div class="mx-24 p-8">
      <div className="my-6">
        ...
        <div>
          <div className="flex justify-between items-center">
            ...
            <p className="font- text-[14px] text-darkgreen font-[700] leading-[25.62px] border-b-2 border-darkgreen cursor-pointer">
              See all
            </p>
          </div>
        </div>
      ...
      <div className="flex justify-center items-center">
        <div className="w-1/3 h-[510px]">
          <img src={T1} className="" width={"350px"} height="205" />
          <p className="w-[75%]  font-dm-sans text-darkgreen text-[18.67px] font-[700] leading-[26.13px] py-2">
            2024 Shimane Club Cup Badminton New Year's Izumo Tournament
          </p>
        ...
        <div className="w-1/3 h-[510px]">
          <img src={T2  } className="" width={"350px"} height="205" />
          <p className="w-[75%] font-dm-sans text-darkgreen text-[18.67px] font-[700] leading-[26.13px] py-2">
            2024 Shimane Club Cup Badminton New Year's Izumo Tournament
          </p>
          <div className="w-[80%] my-7">
        ...
        <div className="w-1/3 h-[510px]">
          <img src={T3} className="" width={"350px"} height="205" />
          <p className="w-[75%]  font-dm-sans text-darkgreen text-[18.67px] font-[700] leading-[26.13px] py-2">
            2024 Shimane Club Cup Badminton New Year's Izumo Tournament
          </p>
          <div className="w-[80%] my-7">
