      ...
      <div className="w-screen h-screen hidden sm:flex">
        ...
        <div className="bg-white w-1/2 h-full flex items-center justify-center ">
          <div>
            ...
            <button className="w-[335px] bg-green text-white text-xl font-sans font-thin rounded-md text-center px-3 py-2 mt-4 mb-4 drop-shadow-sm cursor-pointer shadow-custom">
              Create An Account
            </button>
            <br />
            <button className="w-[335px] bg-white text-green border-2 border-green font-thin  text-xl font-sans rounded-md px-3 py-2 cursor-pointer">
              Sign in
            </button>
          </div>
        </div>
